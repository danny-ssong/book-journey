...
export default function Loading({ text = '로딩 중...', variant = 'card', size = 'sm', className }: LoadingProps) {
  const styles = sizeStyles[size]

  if (variant === 'inline') {
    return (
      <div className={cn('flex items-center justify-center gap-2 text-muted-foreground', styles.padding, className)}>
