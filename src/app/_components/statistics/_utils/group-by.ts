...
export function getGroupByAuthor(posts: PostWithBook[]) {
  const groupedByAuthor = posts.reduce((acc: Record<string, PostWithBook[]>, post) => {
...
export function getGroupByMonth(posts: PostWithBook[]) {
  const groupedByMonth = posts.reduce((acc: Record<string, PostWithBook[]>, post) => {
...
export function getGroupByYear(posts: PostWithBook[]) {
  const groupedByYear = posts.reduce((acc: Record<string, PostWithBook[]>, post) => {
